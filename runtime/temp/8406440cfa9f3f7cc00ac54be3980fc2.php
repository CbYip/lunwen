<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:60:"D:\phpStudy\WWW\lunwen/admin/index\view\goods\goods_add.html";i:1504763709;s:58:"D:\phpStudy\WWW\lunwen/admin/index\view\public\header.html";i:1504833948;s:56:"D:\phpStudy\WWW\lunwen/admin/index\view\public\left.html";i:1504659212;s:58:"D:\phpStudy\WWW\lunwen/admin/index\view\public\footer.html";i:1504506358;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
    ...
    $('#doc-select-2').change(function () {
        ...
        for(var i = 0; i< length; i++){
            content += '<br/>' +
                ...
                '                            <label for="goodsnum" class="am-u-sm-3 am-form-label">库存 / goodsnum</label>\n' +
                '                            <div class="am-u-sm-9">\n' +
                '                                <input type="text" class="typename" name="goodsnum[]" placeholder="添加商品分类">\n' +
                '                            </div>\n' +
                '                        </div>\n' +
                '                        <div class="am-form-group">\n' +
                '                            <label for="goodsprice" class="am-u-sm-3 am-form-label">单价 / goodsprice</label>\n' +
