<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:65:"D:\WebTest\lunwen\lunwen/admin/index\view\goods\comment_list.html";i:1506678676;s:60:"D:\WebTest\lunwen\lunwen/admin/index\view\public\header.html";i:1506646436;s:58:"D:\WebTest\lunwen\lunwen/admin/index\view\public\left.html";i:1507431544;s:60:"D:\WebTest\lunwen\lunwen/admin/index\view\public\footer.html";i:1504506358;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    $(".delete").click(function () {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo url('goods/comment_del_all'); ?>",
            data: {'temp':temp},
            datatype: "json",
            success:function (data) {
                if(data == 0){
                    alert("删除失败!");
                    window.location.href="<?php echo url('goods/comment_list'); ?>";
                }else{
                    alert("删除成功！");
    ...
    $('.user').on('click','.del',function () {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo url('goods/comment_del_one'); ?>",
            data: {"id":id},
            dataType:"json",
            success:function (data) {
                if(data != 0){
