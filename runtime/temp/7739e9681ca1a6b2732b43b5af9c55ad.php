<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:61:"D:\WebTest\lunwen\lunwen/admin/index\view\index\question.html";i:1506675830;s:60:"D:\WebTest\lunwen\lunwen/admin/index\view\public\header.html";i:1506646436;s:58:"D:\WebTest\lunwen\lunwen/admin/index\view\public\left.html";i:1506678733;s:60:"D:\WebTest\lunwen\lunwen/admin/index\view\public\footer.html";i:1504506358;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="am-u-sm-12 am-u-md-6">
                    <div class="am-btn-toolbar">
                        <div class="am-btn-group am-btn-group-xs">
                            <button type="button" class="am-btn am-btn-default am-btn-success" onclick="window.location.href='<?php echo url('index/question_add'); ?>'"><span class="am-icon-plus"></span> 新增</button>
...
<script type="text/javascript">
    ...
    $('.user').on("click",".edit",function () {
        ...
        url = "<?php echo url('index/question_edit'); ?>";
        str = url + '?id=' +ID;
    ...
    $(".delete").click(function () {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo url('index/delete_all'); ?>",
            data: {'temp':temp},
            datatype: "json",
            success:function (data) {
                if(data == 0){
                    alert("删除失败!");
                    window.location.href="<?php echo url('index/question'); ?>";
                }else{
                    alert("删除成功！");
    ...
    $('.user').on('click','.del',function () {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo url('index/delete_one'); ?>",
            data: {"id":id},
            dataType:"json",
            success:function (data) {
                if(data != 0){
