<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:60:"D:\WebTest\lunwen\lunwen/app/index\view\member\myqrcode.html";i:1507433389;s:58:"D:\WebTest\lunwen\lunwen/app/index\view\public\header.html";i:1505983138;s:55:"D:\WebTest\lunwen\lunwen/app/index\view\public\nav.html";i:1507700617;s:58:"D:\WebTest\lunwen\lunwen/app/index\view\public\footer.html";i:1509409424;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    <div class="my-nav-bar">
        <ol class="am-breadcrumb">
            <li><a href="<?php echo url('memeber/inde'); ?>">首页</a></li>
            <li>我的推广名片</li>
        </ol>
    </div>
    <div class="am-cf cart-panel">
        <div class="withdrawals-panel">
            <div class="am-cf qrcode-title-panel">
                <div class="qrcode-face"><img src="<?php echo $mem['headimgurl']; ?>" class="am-img-responsive" /></div>
                <div class="qrcode-myinfo">
                    <p>我是 <?php echo $mem['nickname']; ?></p>
                    <p>我为易起论文网代言</p>
                </div>
            </div>
            <hr data-am-widget="divider" style="" class="am-divider am-divider-default"/>
            <p class="am-text-center">长按二维码保存或分享</p>
            <p class="am-text-center"><img src="<?php echo $qrcode; ?>" class="qrcode-qrcode" /></p>
            <!--<hr data-am-widget="divider" style="" class="am-divider am-divider-default"/>-->
