<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:62:"D:\WebTest\lunwen\lunwen/admin/index\view\goods\type_edit.html";i:1504763410;s:60:"D:\WebTest\lunwen\lunwen/admin/index\view\public\header.html";i:1506646436;s:58:"D:\WebTest\lunwen\lunwen/admin/index\view\public\left.html";i:1507431544;s:60:"D:\WebTest\lunwen\lunwen/admin/index\view\public\footer.html";i:1504506358;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="am-u-sm-12 am-u-md-9">
                    <form class="am-form am-form-horizontal" method="post">
                        <div class="am-form-group">
                            <label for="typename" class="am-u-sm-3 am-form-label">分类名 / typeNames</label>
                            <div class="am-u-sm-9">
                                <input type="text" class="typename" name="typename" value="<?php echo $type['typename']; ?>">
                            </div>
                        </div>
                        <div class="am-form-group" id="type">
                            ...
                            <div class="am-u-sm-9">
                                <select id="doc-select-1" name="type">
                                    ...
                                    <?php endif; if(is_array($class) || $class instanceof \think\Collection || $class instanceof \think\Paginator): $i = 0; $__LIST__ = $class;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($type['pid'] == $vo['ID']): ?>
