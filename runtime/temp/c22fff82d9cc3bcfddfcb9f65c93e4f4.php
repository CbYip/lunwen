<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"D:\WebSite\Test_php\lunwen\lunwen/app/index\view\good\checkout.html";i:1505099218;s:67:"D:\WebSite\Test_php\lunwen\lunwen/app/index\view\public\header.html";i:1504925608;s:67:"D:\WebSite\Test_php\lunwen\lunwen/app/index\view\public\footer.html";i:1505053747;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="container">
    ...
    <div class="gray-panel">
        ...
        <div class="paoduct-title-panel">
            <h2 class="checkout-h2"><span class="am-badge am-round am-badge-warning ">2</span> 确认收货地址 <span style="float: right"><a href="<?php echo url('good/address', ['order' => $shoporder['ordernumber']]); ?>">添加</a> </span></h2>
    ...
    <script type="text/javascript">
        ...
        $('.sub').click(function () {
            ...
            if(addid == undefined){
                ...
                $.ajax({
                    type:"post",
                    url:"<?php echo url('good/checkout'); ?>",
                    data:{'orderid': orderid, "addid":addid, "goodid":goodid},
                    dataType:"json",
                    success:function (data) {
                        if(data != 0){
